...
function handleSetTitle(event: Electron.IpcMainEvent, title: string) {
    console.log('handleSetTitle', title);
...
const createWindow = (): void => {
    ...
    const originMenu = defaultMenu(app, shell);

    const customMenu: Electron.MenuItemConstructorOptions = {
        label: app.name,
        submenu: [
            {
    ...
    originMenu.splice(4, 0, customMenu);

    Menu.setApplicationMenu(Menu.buildFromTemplate(originMenu));
